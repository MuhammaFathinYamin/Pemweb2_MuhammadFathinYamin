...
<section class="contact">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="contact-form" style="background: #247D31;">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="contact-address">
                                ...
                                <div class="contact-details">
                                    ...
                                    <h6>Alamat</h6>
                                    <p> Jl. H. Suhaimi No.63, 
                                        <br> Duren Mekar, Kec. Bojongsari, 
                                        <br> Kota Depok, Jawa Barat 16518</p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
                                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                        <h6>Email</h6>
                                        <p>ppuqdepok@gmail.com
                                            <br> mediauq@gmail.com
                                        </p>
                                    </div>
                                    <br>
                                    <div class="contact-details">
