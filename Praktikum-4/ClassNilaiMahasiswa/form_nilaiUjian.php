...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="#" method="post">
            ...
            <div class="d-flex justify-content-center mt-3">
                ...
                <div class="col-md-6">
                    ...
                    <button type="button" class="btn btn-primary"><a style="text-decoration: none; color:white;" href="form_nilaiUjian.php">Reset Data</a></button>
                </div>
            </div>
        ...
        $data  = new NilaiMahasiswa($_POST['nim'] ?? '', '', $_POST['matkul'] ?? '', $_POST['nilai'] ?? '');
