...
$array_maha1 = new Mahasiswa(get_NimRandom(), "Ardi", 2012, "Teknik Informatika", 2.0);
$array_maha2 = new Mahasiswa(get_NimRandom(), "Kimi", 2018, "Teknik Informatika", 2.7);
$array_maha3 = new Mahasiswa(get_NimRandom(), "Rifki H", 2019, "Sistem Informati", 3.0);
$array_maha4 = new Mahasiswa(get_NimRandom(), "Akmal F", 2020, "Teknik Informatika", 3.5);
$array_maha5 = new Mahasiswa(get_NimRandom(), "Apri W", 2021, "Teknik Informatika", 4.0);
