<?php
include('../../Project-1/front-end/layout/head.html');
include('../../Project-1/front-end/layout/side.html');

include('../../Project-1/class/class-pasien.php');
include('../../Project-1/class/class-bmi.php');
include('../../Project-1/class/class-bmi-pasien.php');


$patient1 = new Patient(1, '001', 'Ahmad', 'makassar', '2011/5/3', 'jannahpro@gmail.com', 'L');
$bmi1 = new BMI(69.8, 169);
$bmiPatient1 = new BMIPatient(1, $bmi1, date("Y-m-d"), $patient1);


$patient2 = new Patient(2, '002', 'Rina', 'soklandia', '2015/6/1', 'bulgaMax@gmail.com', 'P');
$bmi2 = new BMI(55.3, 165);
$bmiPatient2 = new BMIPatient(2, $bmi2, date("Y-m-d"), $patient2);

$patient3 = new Patient(3, '003', 'Lutfi', 'Gotham City', '1992/6/1', 'maduralite@gmail.com', 'L');
            ...
            <div class="card-body">
                ...
                ?>
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <img src="../assets/dist/img/bmi/<?= $gender_type ?>_a1.png" class="img-fluid mb-3" style="max-width: 80%; height: 75%;opacity: <?= $opa1 ?>;">
                                <h5 class="text-center"> Kekurangan Bobot </h5>
                                <h5 class="text-center">
                                    < 18.5 </h5>
                            </div>
                            <div class="col-sm">
                                <img src="../assets/dist/img/bmi/<?= $gender_type ?>_a2.png" class="img-fluid mb-3" style="max-width: 80%; height: 75%;opacity: <?= $opa2 ?>;">
                                <h5 class="text-center"> Sehat </h5>
                                <h5 class="text-center"> 18.5 - 23.9 </h5>

                            </div>
                            <div class="col-sm">
                                <img src="../assets/dist/img/bmi/<?= $gender_type ?>_a3.png" class="img-fluid mb-3" style="max-width: 80%; height: 75%;opacity: <?= $opa3 ?>;">
                            ...
                            <div class="col-sm">
                                <img src="../assets/dist/img/bmi/<?= $gender_type ?>_a4.png" class="img-fluid  mb-3" style="max-width: 80%; height: 75%;opacity: <?= $opa4 ?>;">
                            ...
                            <div class="col-sm">
                                <img src="../assets/dist/img/bmi/<?= $gender_type ?>_a5.png" class="img-fluid mb-3" style="max-width: 80%; height: 75%;opacity: <?= $opa5 ?>;">
...
<?php
include('../../Project-1/front-end/layout/footer.html');
