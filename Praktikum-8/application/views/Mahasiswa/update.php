...
<?php echo form_open('mahasiswa/save')?>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" type="text" class="form-control" value="<?=$mhsedit->nim?>" required>
      </div>
    </div>
  </div>
  <!-- Nama Lengkap -->
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama" name="nama" type="text" class="form-control" value="<?=$mhsedit->nama?>" required>
      </div>
    </div>
  </div>
  <!-- Jenis Kelamin -->
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="custom-control custom-radio custom-control-inline">
        <input name="gender" id="jk_0" type="radio" class="custom-control-input" value="L" <?=$checked_l?>> 
        <label for="jk_0" class="custom-control-label">Laki-Laki</label>
      </div>
      <div class="custom-control custom-radio custom-control-inline">
        <input name="gender" id="jk_1" type="radio" class="custom-control-input" value="P" <?=$checked_p?>> 
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <select id="prodi" name="prodi_kode" class="custom-select">
